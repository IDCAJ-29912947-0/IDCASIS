...
--
-- Servidor: localhost
-- Tiempo de generación: 03-03-2018 a las 22:48:21
...
(4, '2018-02-26', '2018-03-03', 714286, 85714.3, 800000, 5, 0, 'Curso en Semana Santa', 3, NULL, 1, 11, 1, 1, 'A'),
(5, '2018-03-05', '2018-03-09', 446429, 53571.4, 500000, 5, 30, 'Curso dictado en Semana Santa, tomar precauciones.', 3, 4, 1, 2, 1, 1, 'C');
...
(1, 'Efectivo', 'A'),
(2, 'DepÃ³sito Bancario', 'A'),
(3, 'Transferencia desde el mismo banco', 'A'),
(4, 'Transferencia desde otro banco', 'A'),
...
(3, 'Matutino', '08:00:00', '12:00:00', 'A', 'A'),
(4, 'Vespertino', '02:30:00', '06:00:00', 'P', 'A');
...
ALTER TABLE `curso`
  ...
  ADD CONSTRAINT `curso_ibfk_4` FOREIGN KEY (`fk1_turno`) REFERENCES `turno` (`cod_tur`) ON UPDATE CASCADE,
  ADD CONSTRAINT `curso_ibfk_5` FOREIGN KEY (`fk2_turno`) REFERENCES `turno` (`cod_tur`) ON UPDATE CASCADE,
  ADD CONSTRAINT `curso_ibfk_6` FOREIGN KEY (`fky_horario`) REFERENCES `horario` (`cod_hor`) ON UPDATE CASCADE;
...
--
ALTER TABLE `falla`
  ADD CONSTRAINT `falla_ibfk_1` FOREIGN KEY (`fky_alumno`) REFERENCES `alumno` (`cod_alu`) ON UPDATE CASCADE;
