	...
	<div class="container">
	   ...
	   <div class="row mt-2">
			...
			<div class="col-md-4 col-12">
		    	...
		    	value="<?php echo $usuario['nom_usu'] ?>" readonly>
			</div>
	   </div> 	   
	   ...
	   <div class="row mt-2">
			...
			<div class="col-md-4 col-12">
		    	...
		    	value="<?php echo $usuario['ape_usu'] ?>" readonly>
			</div>
	   </div> 
	   ...
	   <div class="row mt-2">
			...
			<div class="col-md-3 col-12">
		    	...
		    	value="<?php echo $usuario['log_usu'] ?>" readonly>
			</div>
	   </div> 
	   ...
	   <div class="row mt-2">
			...
			<div class="col-md-6 col-12">
		    	...
		    	value="<?php echo $usuario['ema_usu'] ?>" readonly>
			</div>
	   </div> 
