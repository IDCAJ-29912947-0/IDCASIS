...
$usu_pun=$obj->filtrar($_REQUEST["log_usu"], $nom_usu="", $ape_usu="", $ema_usu="");  
$usuario=$obj->extraer_dato($usu_pun);
...
<form action="../../../backend/controlador/usuario.php" method="POST">
	...
	<div class="container">
	   ...
	   <div class="row mt-2">
			...
			<div class="col-md-4 col-12">
		    	...
		    	value="<?php echo $usuario['nom_usu'] ?>">
			</div>
	   </div> 	   
	   ...
	   <div class="row mt-2">
			...
			<div class="col-md-4 col-12">
		    	...
		    	value="<?php echo $usuario['ape_usu'] ?>">
			</div>
	   </div> 
	   ...
	   <div class="row mt-2">
			...
			<div class="col-md-3 col-12">
		    	...
		    	value="<?php echo $usuario['log_usu'] ?>">
			</div>
	   </div> 
	   ...
	   <div class="row mt-2">
			...
			<div class="col-md-6 col-12">
		    	...
		    	value="<?php echo $usuario['ema_usu'] ?>">
			</div>
	   </div> 
			...
			<div class="col-md-4 col-12">
			  ...
			  <option value="X">Seleccione...</option>
		    	<?php
		    		...
		    		{
		    			$selected=($rol["cod_rol"]==$usuario['fky_rol'])?"selected":"";
    ...
    <input type="hidden" name="fky_rol_old" id="fky_rol_old" value="<?php echo $usuario['fky_rol'] ?>">				
