...
<head>
	<meta charset="UTF-8">
	<title>Listar Tipo de Curso</title>
			...
			<div class="col-12 text-center ">
	    		...
	    		<div class="row mt-1 justify-content-center bg-light">
					<?php
						...
						$num_fil=0;
						$resultado=$obj->filtrar($cod_tip_cur="",$obj->nom_tip_cur,$fky_area="",$fky_empresa="",$est_tip_cur="");
						while(($datos=$obj->extraer_dato($resultado))>0){
						$num_fil++;	
					?>

						<div class="col-md-1 col-12 border border-white text-center">
		  						<a href="<?php echo "ver_tipo_curso.php?cod_tip_cur=$datos[cod_tip_cur]"?>"><i class="fas fa-eye"></i></a> 
		  						<a href="<?php echo "modificar_tipo_curso.php?cod_tip_cur=$datos[cod_tip_cur]"?>"><i class="fas fa-edit"></i></a>  
		  						<a href="<?php echo $obj->ruta_contenido_frontend.$datos['url_tip_cur'] ?>" target="_blank"><i class="fas fa-paperclip"></i></a>  
						</div>
						...
						<div class="col-md-1 col-12 border border-white text-center">
		   					  <span><?php echo $datos['hor_tip_cur']; ?></span>
						</div>

						<div class="col-md-1 col-12 border border-white text-center">
		   					  <span><?php echo $datos['min_tip_cur']; ?></span>
						</div>																		

						<div class="col-md-1 col-12 border border-white text-center">
		   					  <span><?php echo $datos['max_tip_cur']; ?></span>
						</div>

						<div class="col-md-2 col-12 border border-white text-left">
		     					<span><?php echo $datos['nom_are']; ?></span>
						</div>								
						...
						<div class="col-md-1 col-12 border border-white">
		  					    <span>
		     						<?php echo ($datos['est_tip_cur']=="A") ? "Activo":"Inactivo"; ?>
		     					</span>
						</div>
