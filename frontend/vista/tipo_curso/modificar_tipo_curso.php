...
<head>
	<meta charset="UTF-8">
	<title>Modificar Tipo de Curso</title>
	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-2 bg-light align-items-center">
			...
			<div class="col-md-6 col-12">	   
		  		  ...
		  		  placeholder="Nombre del Curso" value="<?php echo $datos['nom_tip_cur']?>">
			</div>
	  </div>
	  ...
	  <div class="row mt-2 bg-light align-items-center">
			...
			<div class="col-md-3 col-12">	   
		  		  <input type="text" name="hor_tip_cur" id="hor_tip_cur" required="required" maxlength="3" class="form-control" placeholder="Horas Académicas" value="<?php echo $datos['hor_tip_cur']?>">
			</div>
	  </div>	  
	  ...
	  <div class="row mt-2 bg-light align-items-center">
			...
			<div class="col-md-7 col-12">	   
		  		  <input type="text" name="cer_tip_cur" id="cer_tip_cur" required="required" maxlength="50" class="form-control" placeholder="Nombre que aparecer&aacute; en el certificado." value="<?php echo $datos['cer_tip_cur']?>">
			</div>
	  </div>	
	  ...
	  <div class="row mt-2 bg-light align-items-center">
			...
			<div class="col-md-7 col-12">	   
		  		  <textarea name="des_tip_cur" id="des_tip_cur" cols="30" rows="5" required="required" class="form-control"><?php echo $datos['des_tip_cur']?>
		  		  </textarea>
			</div>
	  </div>
	  ...
	  <div class="row mt-2 bg-light align-items-center">
			...
			<div class="col-md-7 col-12">	
			      <textarea name="obj_tip_cur" id="obj_tip_cur" class="form-control" required><?php echo $datos['obj_tip_cur']?></textarea>   
			</div>
	  </div>
	  ...
	  <div class="row mt-2 bg-light align-items-center">
			...
			<div class="col-md-4 col-12">	   
		  		  ...
		  		  value="<?php echo $datos['min_tip_cur']?>">
			</div>
	  </div>
	  ...
	  <div class="row mt-2 bg-light align-items-center">
			...
			<div class="col-md-4 col-12">	   
		  		  ...
		  		  value="<?php echo $datos['max_tip_cur']?>">
			</div>
	  </div>
	  ...
	  <div class="row mt-2 bg-light align-items-center">
			...
			<div class="col-md-7 col-12">	
		  	...
		  	<input type="file" name="url_tip_cur" id="url_tip_cur" class='form-control' value="<?php echo $datos['url_tip_cur']?>"> 
	  ...
	  <div class="row mt-2 bg-light align-items-center">
	   ...
	   <div class="row mt-2 bg-light">
	  		 <div class="col-12  text-center">
		    	 <input type="submit" class="btn btn-primary btn-lg" value="Modificar Tipo de Curso">
			</div>
	   </div>
...
<input type="hidden" name="cod_tip_cur" id="cod_tip_cur" value="<?php echo $datos['cod_tip_cur']?>">			
</form>	
</body>
</html>
