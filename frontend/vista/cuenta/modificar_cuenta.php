	...
	<div class="col-8  ">
	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-4 col-12">
		    <input type="text" name="rif_cue" id="rif_cue" required="required" maxlength="15" class="form-control" placeholder="RIF de la Cuenta" value="<?php echo $cuenta['rif_cue']; ?>">
		</div>
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-6 col-12">
		   <input type="text" name="nom_cue" id="nom_cue" required="required" maxlength="25" class="form-control" placeholder="Titular de la Cuenta" value="<?php echo $cuenta['nom_cue']; ?>">
		</div>
	  ...
	  <div class="row mt-2 bg-light">
	  	 <div class="col-12  text-center">
		     <input type="submit" class="btn btn-primary btn-lg" value="Modificar Cuenta">
		</div>
	   </div>	  	  
    </div>
  </div>
...
<input type="hidden" name="cod_cue" id="cod_cue" value="<?php echo $cuenta["cod_cue"];?>">		
</form>	
</body>
</html>
