	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-8 col-12">
		    <input type="text" name="nom_emp" id="nom_emp" maxlength="50" class="form-control" placeholder="Nombre de la Empresa" onkeyup="return solo_letras();">
		</div>
	  ...
	  <div class="row mt-2 bg-light">
	  	 <div class="col-12  text-center">
		     <input type="submit" class="btn btn-primary btn-lg" value="Filtrar Empresa">
		</div>
	   </div>	
