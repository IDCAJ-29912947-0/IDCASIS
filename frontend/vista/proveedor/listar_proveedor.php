			...
			<div class="col-10 text-center ">
	    		...
	    		<div class="row mt-1 justify-content-center bg-light">
					<?php
						...
						$num_fil=0;
						$resultado=$obj->filtrar("",$obj->nom_pro,"");
						while(($datos=$obj->extraer_dato($resultado))>0){
						$num_fil++;	
					?>

						<div class="col-md-1 col-12 border border-white text-center">
		  						<a href="<?php echo "ver_proveedor.php?cod_pro=$datos[cod_pro]"?>"><i class="fas fa-eye"></i></a> 
		  						<a href="<?php echo "modificar_proveedor.php?cod_pro=$datos[cod_pro]"?>"><i class="fas fa-edit"></i></a>  
						</div>

						<div class="col-md-2 col-12 border border-white">
		  					   <span><?php echo $datos['rif_pro']; ?></span>
						</div>

						<div class="col-md-4 col-12 border border-white text-left">
		   					  <span><?php echo $datos['nom_pro']; ?></span>
						</div>

						<div class="col-md-2 col-12 border border-white text-left">
		   					  <span><?php echo $datos['te1_pro']; ?></span>
						</div>																		

						<div class="col-md-2 col-12 border border-white text-left">
		   					  <span><?php echo $datos['te2_pro']; ?></span>
						</div>		

						<div class="col-md-1 col-12 border border-white">
		  					    <span>
		     						<?php echo ($datos['est_pro']=="A") ? "Activo":"Inactivo"; ?>
		     					</span>
						</div>
