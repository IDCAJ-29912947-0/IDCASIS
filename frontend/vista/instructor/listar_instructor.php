			...
			<div class="col-10 text-center ">
	    		...
	    		<div class="row mt-1 justify-content-center bg-light">
					<?php
						...
						$num_fil=0;
						$resultado=$obj->filtrar("",$obj->nom_ins,"");
						while(($datos=$obj->extraer_dato($resultado))>0){
						$num_fil++;	
					?>

						<div class="col-md-1 col-12 border border-white text-center">
		  						<a href="<?php echo "ver_instructor.php?cod_ins=$datos[cod_ins]"?>"><i class="fas fa-eye"></i></a> 
		  						<a href="<?php echo "modificar_instructor.php?cod_ins=$datos[cod_ins]"?>"><i class="fas fa-edit"></i></a>  
						</div>

						<div class="col-md-2 col-12 border border-white">
		  					   <span><?php echo $datos['ide_ins']; ?></span>
						</div>

						<div class="col-md-2 col-12 border border-white text-left">
		   					  <span><?php echo $datos['nom_ins']; ?></span>
						</div>

						<div class="col-md-2 col-12 border border-white text-left">
		   					  <span><?php echo $datos['ape_ins']; ?></span>
						</div>

						<div class="col-md-2 col-12 border border-white text-left">
		   					  <span><?php echo $datos['te1_ins']; ?></span>
						</div>																		

						<div class="col-md-2 col-12 border border-white text-left">
		   					  <span><?php echo $datos['te2_ins']; ?></span>
						</div>		

						<div class="col-md-1 col-12 border border-white">
		  					    <span>
		     						<?php echo ($datos['est_ins']=="A") ? "Activa":"Inactiva"; ?>
		     					</span>
						</div>
