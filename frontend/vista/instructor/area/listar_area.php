	...
	<div class="col-6 text-center ">
	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-1 bg-primary text-white text-center">
		...
		$num_fil=0;
		$resultado=$obj->filtrar("",$obj->nom_are,"");
		while(($datos=$obj->extraer_dato($resultado))>0){
		$num_fil++;	
		?>

		<div class="col-md-3 col-12 border border-white text-center">
		  <a href="<?php echo "ver_area.php?cod_are=$datos[cod_are]"?>"><i class="fas fa-eye"></i></a> 
		  <a href="<?php echo "modificar_area.php?cod_are=$datos[cod_are]"?>"><i class="fas fa-edit"></i></a>  
		</div>

		<div class="col-md-2 col-12 border border-white">
		     <span><?php echo $datos['cod_are']; ?></span>
		</div>
		...
		<div class="col-md-3 col-12 border border-white">
		     <span>
		     	<?php echo ($datos['est_are']=="A") ? "Activa":"Inactiva"; ?>
		     </span>
		</div>
