...
<head>
	<meta charset="UTF-8">
	<title>Listar Medio Publicitario</title>
...
<form action="listar_medio_publicidad.php" method="POST">
	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-1 bg-primary text-white text-center">
		...
		<div class="col-md-6 col-12 border border-white ">
		     <span>Nombre del Medio Publicitario</span>
		</div>
		...
		$num_fil=0;
		$resultado=$obj->filtrar("",$obj->nom_med,"");
		while(($datos=$obj->extraer_dato($resultado))>0){
		$num_fil++;	
		?>

		<div class="col-md-2 col-12 border border-white text-center">
		  <a href="<?php echo "ver_medio_publicidad.php?cod_med=$datos[cod_med]"?>"><i class="fas fa-eye"></i></a> 
		  <a href="<?php echo "modificar_medio_publicidad.php?cod_med=$datos[cod_med]"?>"><i class="fas fa-edit"></i></a>  
		</div>

		<div class="col-md-2 col-12 border border-white">
		     <span><?php echo $datos['cod_med']; ?></span>
		</div>

		<div class="col-md-6 col-12 border border-white text-left">
		     <span><?php echo $datos['nom_med']; ?></span>
		</div>

		<div class="col-md-2 col-12 border border-white">
		     <span>
		     	<?php echo ($datos['est_med']=="A") ? "Activo":"Inactivo"; ?>
		     </span>
		</div>
