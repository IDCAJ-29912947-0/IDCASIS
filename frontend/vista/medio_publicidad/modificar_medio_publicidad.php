...
<head>
	<meta charset="UTF-8">
	<title>Modificar Medio Publicitario</title>
...
<form action="../../../backend/controlador/medio_publicidad.php" method="POST">
	...
	<div class="col-8 text-center ">
	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-2 bg-light">
	  	 <div class="col-12  text-center">
		     <input type="submit" class="btn btn-primary btn-lg" value="Modificar Medio Publicitario">
		</div>
	   </div>	
	...
	<input type="hidden" name="cod_med" id="cod_med" value="<?php echo $datos['cod_med']; ?>">			
</form>	
</body>
</html>
