	...
	<div class="col-8 text-center ">
	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-1 bg-light">
		...
		<div class="col-md-6 col-12">
		    <input type="date" name="ini_cur" id="ini_cur" required="required" class="form-control" placeholder="Fecha de Inicio" value="<?php echo $datos['ini_cur']?>" readonly>
		</div>
	  ...
	  <div class="row mt-1 bg-light">
		...
		<div class="col-md-6 col-12">
		    <input type="date" name="fin_cur" id="fin_cur" required="required" class="form-control" placeholder="Fecha de Finalizaci&oacute;n" value="<?php echo $datos['fin_cur']?>" readonly>
		</div>
	  ...
	  <div class="row mt-1 bg-light">
		...
		<div class="col-md-6 col-12">
		    <input type="text" name="dol_cur" id="dol_cur" required="required" class="form-control" placeholder="Precio en D&oacute;lares" value="<?php echo $datos['dol_cur']?>" readonly>
		</div>
	  ...
	  <div class="row mt-1 bg-light">
		...
		<div class="col-md-3 col-12">
		    <input type="text" name="pre_cur" id="pre_cur" required="required" class="form-control" placeholder="Precio Total en Bs." onkeyup="return desglozar_precio();" value="<?php echo $datos['pre_cur']?>" readonly>
		</div>
	  ...
	  <div class="row mt-1 bg-light">
		...
		<div class="col-md-3 col-12">
		    <input type="text" name="bas_cur" id="bas_cur" required="required" class="form-control" placeholder="Base Imponible en Bs." readonly value="<?php echo $datos['bas_cur']?>" readonly>
		</div>
	  ...
	  <div class="row mt-1 bg-light">
		...
		<div class="col-md-3 col-12">
		    <input type="text" name="iva_cur" id="iva_cur" required="required" class="form-control" placeholder="IVA en Bs." readonly value="<?php echo $datos['iva_cur']?>" readonly>
		</div>
	  ...
	  <div class="row mt-1 bg-light">
		...
		<div class="col-md-4 col-12">
		    <input type="number" name="pag_cur" id="pag_cur" required="required" class="form-control"  min="0" max="100" value="30" readonly>
		</div>
	  ...
	  <div class="row mt-1 bg-light">
		...
		<div class="col-md-8 col-12">
		    <textarea name="obs_cur" id="obs_cur" class="form-control" readonly><?php echo $datos["obs_cur"]?></textarea>
		</div>
