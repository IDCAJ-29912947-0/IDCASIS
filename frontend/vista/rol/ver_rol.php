	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-2">
		...
		<div class="col-md-4 col-12">
		    <input type="text" class="form-control" value="<?php echo $datos['cod_rol']; ?>" readonly>
		</div>
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-4 col-12">
		    <input type="text"  class="form-control" value="<?php echo $datos['nom_rol']; ?>" size="35" readonly >
		</div>
