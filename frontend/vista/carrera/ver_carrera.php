	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-8 col-12">
		    <input type="text" name="nom_car" id="nom_car" required="required" maxlength="50" class="form-control" placeholder="Nombre de la Carrera" value="<?php echo $datos['nom_car']?>" disabled>
		</div>
