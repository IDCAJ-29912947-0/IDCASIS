...
<form action="listar_carrera.php" method="POST">
	...
	<div class="col-11 text-center ">
	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-1 bg-primary text-white text-center">
		...
		$resultado=$obj->filtrar("",$obj->nom_car,"");
		while(($datos=$obj->extraer_dato($resultado))>0){
		$num_fil++;	
		?>

		<div class="col-md-2 col-12 border border-white text-center">
		  <a href="<?php echo "ver_carrera.php?cod_car=$datos[cod_car]"?>"><i class="fas fa-eye"></i></a> 
		  <a href="<?php echo "modificar_carrera.php?cod_car=$datos[cod_car]"?>"><i class="fas fa-edit"></i></a>  
		</div>

		<div class="col-md-4 col-12 border border-white text-left">
		     <span><?php echo $datos['nom_car']; ?></span>
		</div>
		...
		<div class="col-md-1 col-12 border border-white">
		     <span>
		     	<?php echo ($datos['est_car']=="A") ? "Activa":"Inactiva"; ?>
		     </span>
		</div>
