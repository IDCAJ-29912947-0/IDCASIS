	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-4 col-12">
		    <input type="text" name="nom_are" id="nom_are" required="required" maxlength="35" class="form-control" placeholder="Nombre del Área" onkeyup="return solo_letras();">
		</div>
	  ...
	  <div class="row mt-2 bg-light">
	  	 <div class="col-12  text-center">
		     <input type="submit" class="btn btn-primary btn-lg" value="Guardar Área">
		</div>
	   </div>	  	  
    </div>
  </div>
