...
$permiso=$objPermiso->validar_acceso($opcion=24,$fky_usuario=1,$token=md5("12345"));
...
<head>
	...
	<title>Lista la Opci&oacute;n</title>
	...
	<div class="col-10 text-center ">
	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-1 bg-primary text-white text-center">
		...
		<div class="col-md-3 col-12 border border-white ">
		     <span>URL de la Opci&oacute;n</span>
		</div>
		...
		<div class="col-md-1 col-12 border border-white text-center">
		  <a href="<?php echo "ver_opcion.php?cod_opc=$datos[cod_opc]"?>"><i class="fas fa-eye"></i></a> 
		  <a href="<?php echo "modificar_opcion.php?cod_opc=$datos[cod_opc]"?>"><i class="fas fa-edit"></i></a>  
		</div>

		<div class="col-md-1 col-12 border border-white">
		     <span><?php echo $datos['cod_opc']; ?></span>
		</div>

		<div class="col-md-3 col-12 border border-white text-left">
		     <span><?php echo $datos['nom_opc']; ?></span>
		</div>

		<div class="col-md-3 col-12 border border-white text-left">
		     <span><?php echo $datos['url_opc']; ?></span>
		</div>
		...
		<div class="col-md-2 col-12 border border-white">
		     <span>
		     	<?php echo ($datos['est_opc']=="A") ? "Activo":"Inactivo"; ?>
		     </span>
		</div>
