	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-2">
		...
		<div class="col-md-4 col-12">
		    <input type="text" class="form-control" value="<?php echo $datos['cod_con']; ?>" readonly>
		</div>
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-10 col-12">
		    <input type="text"  class="form-control" value="<?php echo $datos['nom_con']; ?>" size="35" readonly >
		</div>
