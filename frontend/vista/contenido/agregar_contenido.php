	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-10 col-12">
		    <input type="text" name="nom_con" id="nom_con" required="required" maxlength="80" class="form-control" placeholder="Nombre del Contenido" onkeyup="return solo_letras();">
		</div>
	  ...
	  <div class="row mt-2 bg-light">
	  	 <div class="col-12  text-center">
		     <input type="submit" class="btn btn-primary btn-lg" value="Guardar Contenido">
		</div>
	   </div>	  	  
    </div>
  </div>
