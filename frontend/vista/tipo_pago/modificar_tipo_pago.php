...
<form action="../../../backend/controlador/tipo_pago.php" method="POST">
	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-2">
		...
		<div class="col-md-8 col-12">
		    ...
		    value="<?php echo $datos['nom_tip_pag']; ?>">
		</div>
	  ...
	  <div class="row mt-2 bg-light">
	  	 <div class="col-12  text-center">
		     <input type="submit" class="btn btn-primary btn-lg" value="Modificar Tipo de Pago">
		</div>
	   </div>	
	...
	<input type="hidden" name="cod_tip_pag" id="cod_tip_pag" value="<?php echo $datos['cod_tip_pag']; ?>">			
</form>	
</body>
</html>
