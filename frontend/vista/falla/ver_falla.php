	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-6 col-12">
		    <input type="text" name="ide_alu" id="ide_alu" required="required" maxlength="15" class="form-control" placeholder="C&eacute;dula del Alumno" value="<?php echo $alumno['ide_alu'] ?>" disabled>
		</div>
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-6 col-12">
		   <textarea name="obs_fal" id="obs_fal" class="form-control" disabled><?php echo $datos['obs_fal'] ?></textarea>
		</div>
