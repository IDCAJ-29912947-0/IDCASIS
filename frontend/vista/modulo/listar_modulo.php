...
$permiso=$objPermiso->validar_acceso($opcion=19,$fky_usuario=1,$token=md5("12345"));
...
<head>
	...
	<title>Listar M&oacute;dulo</title>
	...
	<div class="col-6 text-center ">
	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-1 bg-primary text-white text-center">
		...
		<div class="col-md-3 col-12 border border-white ">
		     <span>URL del M&oacute;dulo</span>
		</div>
		...
		$num_fil=0;
		$resultado=$obj->filtrar("",$obj->nom_mod,"");
		while(($datos=$obj->extraer_dato($resultado))>0){
		$num_fil++;	
		?>

		<div class="col-md-2 col-12 border border-white text-center">
		  <a href="<?php echo "ver_modulo.php?cod_mod=$datos[cod_mod]"?>"><i class="fas fa-eye"></i></a> 
		  <a href="<?php echo "modificar_modulo.php?cod_mod=$datos[cod_mod]"?>"><i class="fas fa-edit"></i></a>  
		</div>
		...
		<div class="col-md-3 col-12 border border-white text-left">
		     <span><?php echo $datos['url_mod']; ?></span>
		</div>		

		<div class="col-md-2 col-12 border border-white">
		     <span>
		     	<?php echo ($datos['est_mod']=="A") ? "Activo":"Inactivo"; ?>
		     </span>
		</div>
