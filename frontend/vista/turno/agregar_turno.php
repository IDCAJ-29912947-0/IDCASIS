	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-2 bg-light">
		...
		<div class="col-md-8 col-12">
		    <input type="text" name="nom_tur" id="nom_tur" required="required" maxlength="20" class="form-control" placeholder="Nombre del Turno">
		</div>
	  ...
	  <div class="row mt-2 bg-light">
	  	 <div class="col-12  text-center">
		     <input type="submit" class="btn btn-primary btn-lg" value="Guardar Turno">
		</div>
	   </div>	  	  
    </div>
  </div>
