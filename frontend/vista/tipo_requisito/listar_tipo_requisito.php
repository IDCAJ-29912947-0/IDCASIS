...
<head>
	<meta charset="UTF-8">
	<title>Listar Tipo de Requisito</title>
	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-1 bg-primary text-white text-center">
		...
		<div class="col-md-7 col-12 border border-white ">
		     <span>Nombre del Tipo de Requisito</span>
		</div>
		...
		$num_fil=0;
		$resultado=$obj->filtrar("",$obj->nom_tip_req,"");
		while(($datos=$obj->extraer_dato($resultado))>0){
		$num_fil++;	
		?>

		<div class="col-md-2 col-12 border border-white text-center">
		  <a href="<?php echo "ver_tipo_requisito.php?cod_tip_req=$datos[cod_tip_req]"?>"><i class="fas fa-eye"></i></a> 
		  <a href="<?php echo "modificar_tipo_requisito.php?cod_tip_req=$datos[cod_tip_req]"?>"><i class="fas fa-edit"></i></a>  
		</div>

		<div class="col-md-1 col-12 border border-white">
		     <span><?php echo $datos['cod_tip_req']; ?></span>
		</div>
		...
		<div class="col-md-2 col-12 border border-white">
		     <span>
		     	<?php echo ($datos['est_tip_req']=="A") ? "Activa":"Inactiva"; ?>
		     </span>
		</div>
