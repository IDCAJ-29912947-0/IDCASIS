	 ...
	 <div class="row bg-primary text-white">
	  ...
	  <div class="row mt-2">
		...
		<div class="col-md-8 col-12">
		    <input type="text" name="nom_tip_req" id="nom_tip_req" required="required" maxlength="50" class="form-control" placeholder="Nombre del Tipo de Requisito" value="<?php echo $datos['nom_tip_req']; ?>" disabled>
		</div>
